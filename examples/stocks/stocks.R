...
library(plotly)
library(dpseg)
source("examples/stocks/_fns.R")

dpath <- "examples/stocks/_data/stock-data/output"
...
#   "examples/stocks/_data/stock-data/src/symbols.csv")
...
# unlink("docs/stocks", recursive = TRUE)
